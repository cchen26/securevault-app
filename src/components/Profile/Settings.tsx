...
const Settings = () => {
  ...
  const [toggleCredentialsExpired] =
    userAPI.useToggleCredentialsExpiredMutation();
      ...
      {isSuccess && (
        <>
              ...
              <li className="list-group-item has-icon">
                ...
                <div className="form-check form-switch ml-auto">
                  <input
                    type="checkbox"
                    onChange={(event) =>
                      toggleSettings(event.target.name as AccountSettings)
                    }
          ...
          <div className="form-group mt-4">
            ...
            <div className="small text-muted mb-3">
              Your credentials will expired after 90 days if not updated.
            </div>
          </div>
          <div className="form-group mb-0">
            <ul className="list-group list-group-sm">
