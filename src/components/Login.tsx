          ...
          <div className="col-lg-5 text-center">
            ...
            <div className="card mt-5">
              <div className="card-body">
                ...
                <form
                  onSubmit={submitQrCode(onVerifyQrCode)}
                ...
                >
                  ...
                  <div className="col mt-3">
                    ...
                    >
                      ...
                      <span role="status">
                        {form.isSubmitting || qrCodeLoading
                          ? "Loading..."
                          : "Verify"}
                      </span>
                    </button>
