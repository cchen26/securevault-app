...
const DocumentDetails = () => {
  ...
  const {
    ...
    error: _error,
    isSuccess,
  } = documentAPI.useFetchDocumentQuery(documentId!);
  const [
    updateDocument,
    {
      data: _updateData,
      isLoading: _updateLoading,
      error: _updateError,
      isSuccess: _updateSuccess,
    },
  ] = documentAPI.useUpdateDocumentMutation();
  const [
    downloadDocument,
    {
      data: _downloadData,
      ...
      isSuccess: _downloadSuccess,
    },
  ] = documentAPI.useDownloadDocumentMutation();

  const isFieldValid = (fieldName: keyof DocumentForm): boolean =>
    getFieldState(fieldName, form).isTouched &&
    !getFieldState(fieldName, form).invalid;

  const onUpdateDocument = async (form: DocumentForm) =>
                ...
                <div className="row align-items-center">
                  <div className="col-md-3">
                    <div className="text-center border-end">
                      <img
                        src={documentData.data.document.icon}
                  ...
                  <div className="col-md-9">
                    <div className="ms-3 text-lg-start text-sm-center text-xs-center">
                      <h4 className="card-title mb-2 mt-sm-3">
                        {documentData.data.document.name}
                      </h4>
                      <div className="row mt-3">
                        <div className="col-md-12">
                          <button
                            ...
                            className="btn btn-primary downloadb"
                          >
                            <i className="bi bi-download"></i> Download
                          </button>
                          {userData?.data.user.authorities.includes(
                            "document:delete"
                          ) && (
              ...
              <div className="row">
                <div className="col-xl-12">
                  <div className="card right-profile-card">
                    <div className="card-body">
                      <form
                        onSubmit={handleSubmit(onUpdateDocument)}
                        ...
                        <div className="row g-3">
                          <div className="col-sm-6">
                            <input
                              ...
                              className="disabled"
                              defaultValue={
                                documentData.data.document.documentId
                              }
                              required
                            />
                          ...
                          <div className="col-sm-6">
                            ...
                            <div className="input-group has-validation">
                              ...
                              <input
                                type="text"
                                {...register("formattedSize")}
                                name="size"
                                className="form-control disabled"
                                defaultValue={
                                  documentData.data.document.formattedSize
                                }
                                placeholder="Size"
                                required
                                readOnly
                          ...
                          <div className="col-12">
                            ...
                            <div className="input-group has-validation">
                              ...
                              <input
                                type="text"
                                {...register("updaterName")}
                                className="form-control disabled"
                                defaultValue={
                                  documentData.data.document.updaterName
                                }
                                placeholder="updaterName"
                                required
                                readOnly
                              />
                              <div className="">
                            ...
                            <div className="input-group has-validation">
                              ...
                              <input
                                ...
                                defaultValue={new Intl.DateTimeFormat("en-US", {
                                  ...
                                  new Date(documentData.data.document.createdAt)
                                )}
                                className="form-control disabled"
                                placeholder="Document name"
                                required
                            ...
                            <div className="input-group has-validation">
                              ...
                              <input
                                ...
                                defaultValue={new Intl.DateTimeFormat("en-US", {
                                  ...
                                  new Date(documentData.data.document.updatedAt)
                                )}
                                className="form-control disabled"
                                placeholder="Size"
                                required
                          ...
                          <div className="col-12">
                            ...
                            <textarea
                              ...
                              name="description"
                              defaultValue={
                                documentData.data.document.description
                              }
                              className={`form-control ' ${
                                form.errors.description ? "is-invalid" : ""
                              } ${
                                isFieldValid("description") ? "is-valid" : ""
                              }`}
